...
InputDecoration buildInputDecoration(String name) {
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0), borderSide: BorderSide(color: viewLineColor, width: 0.5)),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                4.height,
                Text(" Bally Wonger",
                    maxLines: 2, overflow: TextOverflow.ellipsis, style: secondaryTextStyle(color: mpAppTextColor1)),
              ],
            ).expand(),
            Row(
              children: [
...
Widget placeholderWidget() => Image.asset('assets/images/default_img_track.png', fit: BoxFit.cover);
