    ...
    pages = [
      Column(
        ...
        children: [
          ...
          8.height,
          Text('Now the ultricies leo pharetra, in blandit\n libero auctor sed.',
              style: secondaryTextStyle(color: Colors.white), textAlign: TextAlign.center)
        ],
      ),
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
            ...
            Container(
              ...
              child: Align(
                ...
                child: Text(
                  ...
                  Get.toNamed(RouterNames.DASH_BOARD);
                }),
              ),
            ),
            Positioned(
